...
const Hero = () => {
  const [textAnimation] = useTypewriter({
    words: ["Cybersecurity", "Digital Protection", "Threat Defense", "Security Solutions"],
    loop: true,
    typeSpeed: 90,
    delaySpeed: 600,
  });
            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="mb-12 text-center text-sm !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  We are dedicated to providing cutting-edge cybersecurity solutions that protect your digital assets and safeguard your business. With expertise in threat detection, risk management, and security infrastructure, we empower organizations to defend against evolving cyber threats and ensure comprehensive protection in the digital landscape.
                </p>
