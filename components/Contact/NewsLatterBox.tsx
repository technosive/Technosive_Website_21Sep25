  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Stay ahead of emerging threats with our latest cybersecurity insights, vulnerability alerts, and protection strategies delivered directly to your inbox.
      </p>
      <form onSubmit={handleFormSubmit}>
        ...
        >
          {loading ? <Loader /> : "Get Threat Alerts"}
        </button>
        <p className="text-center text-base leading-relaxed text-body-color dark:text-body-color-dark">
          We respect your privacy and ensure secure communications. No spam, only critical security insights. Our{" "}
